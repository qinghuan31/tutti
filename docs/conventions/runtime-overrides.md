...
| `TUTTI_ENABLE_CLAUDE_LIVE_MODEL_DISCOVERY` | [Troubleshooting](./troubleshooting.md)         | Re-enables the hidden Claude live-model discovery session (disabled by default to avoid the shared-credential OAuth refresh race). |
