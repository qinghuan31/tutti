...
export const en = {
  ...
  agentHost: {
    ...
    agentGui: {
      ...
      renameSessionInputLabel: "Session title",
      renameSessionTitleRequired: "Enter a session title.",
      renameSessionTitleTooLong:
        "Session title must be {{maxLength}} characters or fewer.",
      renameSessionSave: "Save",
      renameSessionSaving: "Saving...",
      renameSessionFailed: "Could not rename the session. Try again.",
